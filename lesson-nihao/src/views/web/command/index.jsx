...
import { Table, Progress, Input, Switch, Form } from 'antd'
...
function Lesson(props) {
  ...
  return (
    <div className='steps_wrapper'>
      ...
      <Input addonBefore="姓名：" defaultValue="" style={{ marginBottom: 5 }} onChange={(e) => {
        console.log(e.target.value, 'name')
      }}/>
      <Input addonBefore="手机：" defaultValue="" style={{ marginBottom: 5 }}/>
      <Input addonBefore="配送地址：" defaultValue="" style={{ marginBottom: 5 }}/>
